...
blockpoint_city <- st_join(blockpoints, sf_townships, join = st_within) %>%
...
This means we want to keep only 5.89% of jobs that currently exist in block group 490490015042 We also want to multiple the jobs within block group 490490016022 by 91.55 to get a total of 7604 jobs in the BYU block group area (in other words to add the 7490 jobs that we took away from the RockCanyonElem block group).
...
byu_adjust[1,c(2:98)] <- byu_adjust[1,c(2:98)]*.0589
byu_adjust[2,c(2:98)] <- byu_adjust[2,c(2:98)]*91.55
